...
const VirtualLessons = () => {
  ...
  <>
    ...
    <section id="RTsbsr-581">
        ...
        <div className="virtual-lessons-reasons">
            <p className="reasons-text">First, so long as I can see and hear students (and I have perfect pitch), and they can see and
            ...
            <p className="reasons-text">Second, online students seem to develop more quickly, a stronger, deeper understanding of
            ...
            <p className="reasons-text">Third, the online music education environment presents the opportunity to use many engaging
            ...
            <div className="virtual-lessons-button">
                <a href="" className="cs-button-solid">Get Free Quote</a>
            </div>
        </div>
